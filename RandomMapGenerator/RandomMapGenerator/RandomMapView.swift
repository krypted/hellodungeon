...
//        let buttonStop = UIButton(frame: CGRect(x: 10, y: 10, width: 100, height: 30))
//        buttonStop.backgroundColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.3)
//        buttonStop.setTitle("stop", for: .normal)
//        buttonStop.titleLabel?.textAlignment = .center
//        buttonStop.addTarget(self, action: #selector(stop), for: .touchUpInside)
